...
//     msg_t msg;
//     size_t size =  tmpibqReadTimeout(&((QMKUSBDriver *)ip)->ibqueue, bp, n, timeout, &msg);
//     if(msg != MSG_OK && msg != MSG_RESET)
//         obqResetI(&((QMKUSBDriver *)ip)->obqueue);
//     _writet(ip, (uint8_t *)&msg, sizeof(msg_t), TIME_IMMEDIATE);
//     return size;
// }
