...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_iso_99(
        KC_ESC,             KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,     KC_F11,   KC_F12,             KC_DEL,   LT(3,KC_HOME),  LT(2,KC_END),     KC_MUTE,
    ...
    [_FL] = LAYOUT_iso_99(
        QK_BOOT,            KC_BRID,  KC_BRIU,  KC_TASK,  KC_FILE,  UG_VALD,  UG_VALU,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,    KC_VOLD,  KC_VOLU,            _______,  _______,  _______,    UG_TOGG,
     ...
     CLEAR_MODS,  UG_NEXT,  UG_VALU,  UG_HUEU,  UG_SATU,  SU_PCMA,  _______,  DE_MICR,  _______,  _______,  KC_PSCR,  _______,    _______,                      _______,  _______,  _______,    _______,
        KC_CAPS,  UG_PREV,  UG_VALD,  UG_HUED,  UG_SATD,  UG_SPDU,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,            _______,  _______,  _______,
        _______,  KB_SLEEP,  _______,  _______,  _______,  MYVIA,    BAT_LVL,  NK_TOGG,  _______,  _______,  _______,  _______,              _______,  KC_PGUP,  _______,  _______,  _______,    _______,
    ...
    [_D1] = LAYOUT_iso_99(
        ...
        _______,  BT_HST1,  BT_HST2,  BT_HST3,  P2P4G,    _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  MS_BTN4,            MS_BTN5,  MS_BTN6,  MS_BTN7,    MS_BTN8,
        UG_TOGG,  UG_NEXT,  UG_VALU,  UG_HUEU,  UG_SATU,  UG_SPDU,  _______,  _______,  _______,  _______,  _______,  _______,    _______,                      MS_ACL0,  MS_ACL1,  MS_ACL2,    _______,
        _______,  UG_PREV,  UG_VALD,  UG_HUED,  UG_SATD,  UG_SPDD,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  MS_BTN3,            _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,  BAT_LVL,  NK_TOGG,  _______,  _______,  _______,  _______,              _______,  MS_UP,  _______,  _______,  _______,    _______,
        _______,  _______,  _______,                                _______,                                _______,  _______,    MS_BTN1,  MS_LEFT,  MS_DOWN,  MS_RGHT,  MS_BTN2,  _______            ),
    [_D2] = LAYOUT_iso_99(
    _______,            _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,            _______,  _______,  TG(2),    _______,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [_FL] = {ENCODER_CCW_CW(UG_VALD, UG_VALU)},
    [_D1] = {ENCODER_CCW_CW(MS_WHLD, MS_WHLU)},
    [_D2] = {ENCODER_CCW_CW(MS_WHLL, MS_WHLR)},
    [_MYCKC] = {ENCODER_CCW_CW(MYCKC_KNOBL, MYCKC_KNOBR)},
    [_EN] = {ENCODER_CCW_CW(UG_VALD, UG_VALU)},
    [_MYCKC] = {ENCODER_CCW_CW(MYCKC_KNOBL, MYCKC_KNOBR)},
};
...
bool rgb_matrix_indicators_user() {
    ...
    if (tempVariable > 0) {
        rgb_matrix_set_color(tempVariable, 255, 0, 0);
        custom = true;
    }
    if (testMode) {
        for (int i = 5; i < 9; i++)
...
int process_raw_message(uint8_t *data, uint8_t length) {
    ...
    switch (header.mode) {
        ...
        case MACRO_COMMAND: {
            switch (header.categorie) {
                // case PCMacro:
                //     interpret_pc_macro(&data[2], length);
                //     break;
                // case PCMacro16Bit:
                //     interpret_pc_macro_16_bit(&data[2], length);
                //     break;
                case PCMacroString:
...
#ifdef RAW_ENABLE
bool kc_raw_hid_rx_user(uint8_t src, uint8_t *data, uint8_t length) {
...
#    endif
    ...
    // int diff =
    process_raw_message(data, length);
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    if (record->event.pressed) {
        ...
        if (keycode == KB_SLEEP) {
            wireless_event_t goToSleepEvent = {
                EVT_SLEEP,
            };

            wireless_event_enqueue(goToSleepEvent);
        }
    }
    ...
    if ((keycode >= MYCKC_ESC && keycode <= MYCKC_NUMCOL) || (keycode >= KEEKC_ESC && keycode <= KEEKC_NUMCOL)) {
        ret = false;
    }
    ...
    if (record->event.pressed) {
        ...
        switch (keycode) {
            case SU_PCMA: {
                ...
                kc_raw_hid_send(RAW_HID_SRC_USB, buffer, RAW_EPSIZE);
                break;
            }
        }
    }
