...
enum K6_keycodes { BT_PROFILE1 = QK_USER, BT_PROFILE2, BT_PROFILE3, BT_PAIR, BT_TOGGLE, K4_SAFE_RANGE };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [_BASE] = {{KC_ESC, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_DEL, KC_HOME, KC_END, KC_PGUP, KC_PGDN, RGB_MOD}, {KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_BSPC, KC_NO, KC_NUM, KC_PSLS, KC_PAST, KC_PMNS}, {KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC, KC_NO, KC_NO, KC_P7, KC_P8, KC_P9, KC_PPLS}, {KC_CAPS, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_NUHS, KC_ENT, KC_NO, KC_P4, KC_P5, KC_P6, KC_NO}, {KC_LSFT, KC_NUBS, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_NO, KC_RSFT, KC_UP, KC_P1, KC_P2, KC_P3, KC_PENT}, {KC_LCTL, KC_LGUI, KC_LALT, KC_NO, KC_NO, KC_NO, KC_SPC, KC_NO, KC_NO, KC_NO, KC_RALT, MO(_FL), KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT, KC_P0, KC_PDOT, KC_NO}},
    ...
    */
    ...
    [_FL] = {{QK_BOOT, KC_SLCT, KC_PAUS, KC_APP, _______, RGB_VAD, RGB_VAI, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, _______, KC_PSCR, _______, _______, KC_SLEP, RGB_TOG},
             {BT_PAIR, BT_PRO1, BT_PRO2, BT_PRO3, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_NO, _______, _______, _______, RGB_HUI},
...
bool rgb_matrix_indicators_user() {
    ...
    if (bitFlagIndicator > 0) {
        if (bitFlagIndicator & 0b1) rgb_matrix_set_color(20, 255, 0, 255);
        if (bitFlagIndicator & 0b10) rgb_matrix_set_color(21, 255, 0, 255);
        if (bitFlagIndicator & 0b100) rgb_matrix_set_color(22, 255, 0, 255);
        if (bitFlagIndicator & 0b1000) rgb_matrix_set_color(23, 255, 0, 255);
        if (bitFlagIndicator & 0b10000) rgb_matrix_set_color(24, 255, 0, 255);
        if (bitFlagIndicator & 0b100000) rgb_matrix_set_color(25, 255, 0, 255);
        if (bitFlagIndicator & 0b1000000) rgb_matrix_set_color(26, 255, 0, 255);
        if (bitFlagIndicator & 0b10000000) rgb_matrix_set_color(27, 255, 0, 255);
        if (bitFlagIndicator & 0b100000000) rgb_matrix_set_color(28, 255, 0, 255);
        custom = true;
    }
