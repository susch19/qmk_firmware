...
const key_override_t delete_key_override = ko_make_basic(MOD_MASK_ALT, KC_DELETE, KC_INSERT);
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [_BASE] =  {{KC_ESC,    KC_F1,      KC_F2,      KC_F3,   KC_F4,    KC_F5,   KC_F6, KC_F7,   KC_F8,      KC_F9,     KC_F10, KC_F11, KC_F12, KC_DEL, KC_HOME, KC_END, KC_PGUP, KC_PGDN, RGB_TOG},
                ...
                {KC_TAB,    KC_Q,       KC_W,       KC_E,    KC_R,     KC_T,    KC_Y,  KC_U,    KC_I,       KC_O,      KC_P, KC_LBRC, TD(STARONHOLD), KC_NO, KC_NO, KC_P7, KC_P8, KC_P9, KC_PPLS},
    ...
    [_FL] = {{RESET, KC_SLCK, KC_PAUS, KC_APP, _______, RGB_VAD, RGB_VAI, KC_MPRV, KC_MPLY, KC_MNXT, KC__MUTE, KC__VOLDOWN, KC__VOLUP, KC_INS, KC_PSCR, _______, _______, _______, RGB_MOD},
             ...
             {_______, _______, _______, _______, _______, MYCALC, _______, _______, _______, _______, KC_PSCR, _______, _______, _______, KC_NO, _______, _______, _______, _______},
             ...
             {KC_LSFT, _______, _______, _______, _______, _______, _______, _______, MG_NKRO, _______, _______, KC_APP, KC_NO, KC_RSFT, RGB_SPI, _______, _______, _______, RGB_SAI},
             {_______, KC_LALT, KC_LGUI, KC_NO  , KC_NO  , KC_NO  , _______, KC_NO  , KC_NO  , KC_NO  , LCLS(KC_M), MO(_FL), LCLS(KC_U), _______, RGB_SPD, _______, _______, _______, KC_NO}},
